...
namespace OdinSerializer
{
    ...
    public class QueueFormatter<T> : BaseFormatter<Queue<T>>
    {
        ...
        /// A null value.
        /// </returns>
        protected override Queue<T> GetUninitializedObject()
        {
            return null;
        }
        ...
        protected override void DeserializeImplementation(ref Queue<T> value, IDataReader reader)
        {
            string name;
        ...
        protected override void SerializeImplementation(ref Queue<T> value, IDataWriter writer)
        {
            try
            {
